        ...
        <Menu>
            <MenuButton as={Button}>
                <Box>
                    <Flex justify="center" align="center">
                        <Avatar size={'sm'} mr={2} src={user.avatar} />
            ...
            <MenuList zIndex={10}>
                <MenuItem borderBottom={'1px solid #eee'}>
                    <Flex>
                        <Box>
                            <Avatar size={'md'} mx={2} src={user.avatar} alt={`${user.name}'s Avatar!`} />
                        </Box>
                        <Box fontSize=".9rem">
                            <Text>{user.name}</Text>
                ...
                <MenuItem py={3}>
                    <NextLink href="/actions/new">
                        <Link fontStyle="italic" fontWeight={'bold'} color="gray.500" style={{ textDecoration: 'none' }}>Create New Post</Link>
                    </NextLink>
                </MenuItem>
